...
**No Longer Maintained:** Although it is likely that this plugin will still work when in Visual mode in the classic editor, I am no longer maintaining it. It has not & will not be tested in Gutenberg.

**IMPORTANT:** This plugin **DOES NOT** add any buttons to the editor to help with inserting Bootstrap elements. It simply loads an older version of Bootstrap's CSS to the editor, effectively showing you a preview of Bootstrap elements when in Visual mode. You still have to add the Bootstrap elements to the editor yourself.
...
= 0.2 =
* 5/9/2018
* Updated readme.txt to reflect that the plugin is no longer maintained
* The plugin will most likely continue to work when in Visual mode in the classic editor, but has not and will not be tested with Gutenberg.
...
= 0.2 =
This plugin is outdated & no longer being maintained. It should continue to work with the classic editor, but I am no longer supporting it.